...
class ProfileFragment : Fragment() {
    ...
    private val DEFAULT_IMAGE_URL = "https://picsum.photos/200/300/?blur"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button_save.setOnClickListener {
            ...
            val updates = UserProfileChangeRequest.Builder().setDisplayName(name).setPhotoUri(photo).build()
